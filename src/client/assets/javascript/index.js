...
async function handleCreateRace() {
  try {
    ...
    // const race = DONE - invoke the API call to create the race, then save the result
    ...
    console.log("Error while creating race: ", error);
  }
}
...
function getTracks() {
  ...
  return fetch(`${SERVER}/api/tracks`)
    ...
    .catch((error) => console.log("Couldn't load tracks: ", error));
}
...
function getRacers() {
  ...
  return fetch(`${SERVER}/api/cars`)
    ...
    .catch((error) => console.log("Couldn't load racers: ", error));
}
...
function getRace(id) {
  ...
  return fetch(`${SERVER}/api/races/${id}`)
    .then((result) => result.json())
    .catch((error) => console.log("Couldn't load race: ", error));
}
...
function accelerate(id) {
  ...
  return fetch(`${SERVER}/api/races/${id}/accelerate`, {
    method: "POST",
    ...defaultFetchOpts(),
  }).catch((error) => console.log("Problem with gas pedal: ", error));
}
